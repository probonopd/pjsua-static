...
sudo apt -y install libasound2-dev libopus-dev python-dev curl default-jdk swig # swig3.0
...
curl --upload-file ../pjsip-apps-$VERSION-$ARCH.tar.bz2 https://transfer.sh/
